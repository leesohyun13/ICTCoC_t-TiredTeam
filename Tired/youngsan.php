...
//위험한 사고지역
$query = "select * from accident_data where sigugun_code=21 and state_code=0";
...
//신호등데이터
$query1 = "select * from cross_walk where 구코드=21";
$result1 = mysqli_query($connect, $query1);
$chart_data1 = '';
//중간 사고지역
$query2 = "select * from accident_data where sigugun_code=21 and state_code=1";
//state_code = 등급 0/1/2 =>가장 위험한거는? 0 = 위험 1=중간 2=경고
...
//약한 사고지역
$query3 = "select * from accident_data where sigugun_code=21 and state_code=2";
//state_code = 등급 0/1/2 =>가장 위험한거는? 0 = 위험 1=중간 2=경고
...
<div class="header">
    <h1 class="page-header">
        &nbsp;  &nbsp; &nbsp; 용산구  &nbsp; &nbsp;<img src="/test/img/icon7.png" alt="My Image">
...
<script id="code">
    ...
    var map = new naver.maps.Map('map', {
        //     126.969296 |  37.5310544
        center: new naver.maps.LatLng( 37.5310544, 126.969296 ),
        zoom: 10,
        mapTypeControl : true
