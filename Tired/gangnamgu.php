...
//위험한 사고지역
$query = "select * from accident_data where sigugun_code=1 and state_code=0";
...
$chart_data1 = '';
//중간 사고지역
$query2 = "select * from accident_data where sigugun_code=1 and state_code=1";
//state_code = 등급 0/1/2 =>가장 위험한거는? 0 = 위험 1=중간 2=경고
...
//약한 사고지역
$query3 = "select * from accident_data where sigugun_code=1 and state_code=2";
//state_code = 등급 0/1/2 =>가장 위험한거는? 0 = 위험 1=중간 2=경고
...
<div class="header">
    <h1 class="page-header">
        &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; 강남구 &nbsp; &nbsp; &nbsp; &nbsp;<img src="/test/img/icon7.png" alt="My Image">
...
<script id="code">
    ...
    var map = new naver.maps.Map('map', {
        //   127.022489 | 37.5041968
        center: new naver.maps.LatLng(37.5041968 , 127.022489),
        zoom: 10,
        mapTypeControl : true
